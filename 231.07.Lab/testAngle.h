...
private:
   ...
   {  // setup
      ...
      // verify
      assertEquals(a.radians, M_PI / 2.0);
      assertEquals(dx, 4.0);
      assertEquals(dy, 0);
   }  // teardown
   ...
   {  // setup
      ...
      // verify
      assertEquals(a.radians, (3 * M_PI) / 2.0);
